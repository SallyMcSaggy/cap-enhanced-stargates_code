...
-- Models
ENT.Models = {
	Base="models/junko_enoshima/sg_hd/sgtbase_hd.mdl",
	Chevron="models/junko_enoshima/sg_hd/sgtchev_hd.mdl",
}
-- Sounds
ENT.Sounds = {
	...
	ChevronDHD=Sound("junko_enoshima/tollan_hd/tollan_chevron_hd.mp3"),
...
function ENT:SpawnFunction(p,t)
	...
	local e = ents.Create("stargate_tollan_hd");
...
if (StarGate and StarGate.CAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "stargate_tollan_hd", StarGate.CAP_GmodDuplicator, "Data" )
end