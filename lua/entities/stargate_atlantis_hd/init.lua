...
-- Models
ENT.Models = {
	Base="models/kripalida/sg_hd/base_atlantis_hd.mdl",
	Chevron="models/kripalida/sg_hd/chevron_hd.mdl",
	Dial={
		"models/kripalida/dial/sga_hd_dial_part1.mdl",
		"models/kripalida/dial/sga_hd_dial_part2.mdl",
	},
	Incoming={
		"models/kripalida/incoming/sga_hd_incoming_part1.mdl",
		"models/kripalida/incoming/sga_hd_incoming_part2.mdl",
	},
}
-- Sounds
ENT.Sounds = {
	Ring=Sound("stargate/gate_roll_atlantis.mp3"),
	Ring2=Sound("junko_enoshima/sga_hd/atl_stargate_roll_hd.wav"),
	Open=Sound("junko_enoshima/sga_hd/open_atl_show2.mp3"),
...
function ENT:SpawnFunction(p,t)
	...
	local e = ents.Create("stargate_atlantis_hd");
...
if (StarGate and StarGate.CAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "stargate_atlantis_hd", StarGate.CAP_GmodDuplicator, "Data" )
end