...
--################# SENT CODE #################
ENT.Model = "models/junko_enoshima/dhd_hd/dhd_base.mdl"
ENT.ModelBroken = "models/junko_enoshima/dhd_hd/dhd_open.mdl"
ENT.PlorkSound = "junko_enoshima/tollan_hd/tollan_chevron_hd.mp3"; -- The old sound
ENT.LockSound = "junko_enoshima/dhd_hd/sg1/dhd_hd_dialorb.mp3";
ENT.SkinNumber = 0;
ENT.Healthh = 500;

ENT.ChevronModel = { -- Oh Mark, why u didnt named buttons in same order, like for concept DHD?

	"models/junko_enoshima/dhd_hd/buttons/b33.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b34.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b35.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b36.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b37.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b38.mdl",

	"models/junko_enoshima/dhd_hd/buttons/b20.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b21.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b22.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b23.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b24.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b25.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b26.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b27.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b28.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b29.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b30.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b31.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b32.mdl",

	"models/junko_enoshima/dhd_hd/buttons/b14.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b15.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b16.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b17.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b18.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b19.mdl",

	"models/junko_enoshima/dhd_hd/buttons/b1.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b2.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b3.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b4.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b5.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b6.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b7.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b8.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b9.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b10.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b11.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b12.mdl",
	"models/junko_enoshima/dhd_hd/buttons/b13.mdl",

	"models/junko_enoshima/dhd_hd/buttons/dialorb.mdl",
}
