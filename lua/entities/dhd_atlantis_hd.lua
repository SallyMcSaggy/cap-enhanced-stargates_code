...
function ENT:SpawnFunction(p,tr)
	...
	local e = ents.Create("dhd_atlantis_hd");
	e:SetPos(pos);
	e:Spawn();
	e:Activate();
...
if (StarGate and StarGate.CAP_GmodDuplicator) then
	duplicator.RegisterEntityClass( "dhd_atlantis_hd", StarGate.CAP_GmodDuplicator, "Data" )
end
...
ENT.PrintName = SGLanguage.GetMessage("DHD (Atlantis HD)");
end
